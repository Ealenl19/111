  ...
  <#include "../common/top_header.ftl"/>
    ...
    <div class="container">
        ...
        <div class="label-wr center clearfix">
            <div id="nav-labels">
                <button id="new_pro" class="labels" style="background:rgb(75, 192, 165);color:white;width:100%;padding-left: 8px;padding-right: 8px;" >Category：${gc.name}</button>
            </div>
            ...
            <ul class="items clearfix">
            	...
            	<li class="item">
                    ...
                    <div class="info">
                        ...
                        <div class="school"><span>Recommand</span></div>
                        </#if>
                     </div>
                </li>
                </#list>
        ...
        <div class="pages">
            ...
            <#else>
            <a class="page-arrow arrow-left" href="list?cid=${gc.id!""}&currentPage=1">First page</a>
            </#if>
            ...
            <#else>
	        <a class="page-arrow arrow-right" href="list?cid=${gc.id!""}&currentPage=${pageBean.totalPage}">Last</a>
	        </#if>
        </div>
        <!-- 分页 结束 -->
        </#if>
