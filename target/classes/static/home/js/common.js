    ...
    var lr = function() {
        ...
        placeholder.prototype.dealInputB = function(that) {
            ...
            if( note === 0 ) {
                ...
                alert( $(that.el).data("value") + "Incorrect format");
                that.state = -1;
            } else {
                that.state = 1;
            }
    ...
    $.post(
        ...
        function(res) {
            ...
            if (res.code == 0) {
                ...
                var school_area='<div id="department-container" class="hidden"><div id="department-wrapper"><div class="sel-head"><h2>Choose your collage</h2></div>'+
                    '<div id="sel-d2" class="sel-d2 hidden"><div class="sel-school"><div class="sel-hd"><h3>collage</h3><input type="text" value="" class="department-item" disabled="true">'+
                    '<a href="javascript:;"><img src="http://www.2shoujie.com/resource/image/arr-right.png"></a></div>'+
                    '<div class="sel-content"><div class="school-search"><input placeholder="Please enter the school name" type="text" value="" class=""><ul class="search-down hidden"></ul></div>'+
                    '<ul class="sel-items"></ul></div></div><div class="sel-academy"><div class="sel-hd"><h3>Major</h3><input type="text" value="" class="department-item" disabled="true">'+
                    '<a href="javascript:;"><img src="http://www.2shoujie.com/resource/image/arr-right.png"></a></div><div class="sel-content">'+
                    '<ul class="sel-items"></ul></div></div><div class="sel-adyear"><div class="sel-hd"><h3>Time of Enrollment</h3><input type="text" value="" class="department-item" disabled="true">'+
...
function off_shelf(pid){
    if (!confirm('After removal, the product will not be visible to others. Are you sure to remove it')) {
        return;
    }
    $.post('productedit', 
    		{"pid" : pid,"flag":1},
...
function sold(goods_id){
    ...
    if (!confirm('After the product is sold, you can click to remove it from the shelves and earn points. Other users will not be able to see the product. Are you sure you want to sell it？')) {
    	alert("Cancel");
        return;
    }
