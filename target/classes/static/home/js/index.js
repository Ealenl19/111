...
$(document).ready(function(){
    ...
    if($("body").children(".fade_back").size()==0){
        var feed_back = '<div class="fade_back"><h1><span class="fd_close">关闭</span>反馈给二手街</h1><div class="fade_area">'+
            '<div class="not_good"><h2>Please let us know if you have any discomfort while browsing</h2><textarea id="feedback" placeholder="Hello."></textarea></div>'+
            '<div class="leave_name"><h2>Please give us your contect number</h2><textarea id="contact" placeholder="Email or Phone number"></textarea></div>' +
    ...
    try{
        ...
        try{
            ...
            alert("This browse does not support automatic addition. Please use Ctrl+D to add");
        }
    }
...
if($(".upload-area").length){
    detectFlash("To avoid affecting the image upload function, please cancel the browser's disabling of Flash. For example, under IE: Settings ->Security ->ActiveX");
}
