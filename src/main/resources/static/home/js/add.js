...
function uploadPhoto(showPictureImg,input){
	...
	$.ajax({
		...
		success:function(data){
				...
				if(data.code == 0){
					$("#head-img-box").addClass('hide');
					$(".pop-tip-txt").text('Upload successful!');
...
$(document).ready(function(){
    ...
    if($("body").children(".fade_back").size()==0){
        var feed_back = '<div class="fade_back"><h1><span class="fd_close">close</span>Feedback to us</h1><div class="fade_area">'+
            '<div class="not_good"><h2>Any feed back</h2><textarea id="feedback" placeholder="Hello"></textarea></div>'+
            '<div class="leave_name"><h2>Please give us your contect number</h2><textarea id="contact" placeholder="Emai or phone umber..."></textarea></div>' +
            '<a class="fd_btn" id="commit_fd" href="javascript:void(0);"></a></div></div><div class="thanks_fd">Thank you for your feed back</div>';
