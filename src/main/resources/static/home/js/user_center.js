	...
	$.ajax({
		...
		for(var i = 0;i<resp.length;i++){
			...
			var mypro1 = $('<div class="enshr_each" id="prolist">  ' +
					...
					'<div class="enshr_state"><span id="prostate">Status: selling'+resp[i].state+'</span>' +
					'&nbsp;&nbsp;<span id="prostate">Renew date：'+resp[i].creatTime+'</span>'+
					'<span class="enshrine_it" onclick="sellout('+resp[i].pid+');">Comfirm to sell</span>'+
					'<span class="enshrine_it make_edition" onclick="offshelf('+resp[i].pid+');">delate</span>'+
					'<span class="enshrine_it make_edition" onclick="refresh('+resp[i].pid+');">Polish</span>'+
