    ...
    <div class="container">
            <div class="main center clearfix">
                    ...
                    <ul class="want-list" id="want-list">
                        ...
                        <li class="want-item">
                        	<div class="want-li clearfix">
                        		...
                        		<div class="right">
                        			<h4 class="want-name">【Want to buy】
                        			...
                        			<p class="want-contact">
                        				...
                        				<span>Email：${wantedGoods.student.qq!""}</span>
                        			</p>
                        		</div>
                        	</div>
                        </li>
		        ...
		        <div class="pages">
		            ...
		            <#else>
		            <a class="page-arrow arrow-left" href="list?currentPage=1">First page</a>
		            </#if>
		            ...
		            <#else>
			        <a class="page-arrow arrow-right" href="list?currentPage=${pageBean.totalPage}">Last page</a>
			        </#if>
		        </div>
		        <!-- 分页 结束 -->
		        </#if>
