	            ...
	            <div class="search-box center" >
	               <button class="search-submit" id="search-button" onclick="searchPro()">Search</button> 
	                <div class="input-wr">
	                    ...
	                    <input name="keyword" id="keyword" x-webkit-speech="" placeholder="Search what you want" value="" type="text">
	                    </div>
	                </div>
	            </div>
	        ...
	        <div class="ease2 log-reg" id="have-not-login">
		        ...
		        <div id="have_login" class="clearfix">
		        	<div id="person_info" class="clearfix">
			        	...
			        	<div  style="display:inline;"  class="person_name">
			        		<a href="../index/logout" id="log-btn">&nbsp;&nbsp;&nbsp;&nbsp;Exit</a>
			        	</div>
			        </div>
		        </div>
		        <#else>
	       		<!-- loginandrigist -->
	            <div class="button" ><a href="../index/login">Log in</a></div>
		        </#if>
	        </div>
	    </div>
	</header>
