...
public class Comment extends BaseEntity{
	...
	@ValidateEntity(required=true,requiredLeng=true,minLength=1,maxLength=1000,errorRequiredMsg="Comment cannot be empty",errorMinLengthMsg="Your comment is too short",errorMaxLengthMsg="Maximum 1000 words!")
